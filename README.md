...
| 9 | Codex | `src/bs3_topk_adapt.py`, `scripts/baseline3_top250_adapt.slurm` | Resume script for a final top-k target-similar Baseline3 adaptation run from a saved checkpoint using DA3-GIANT pseudo-labels |
...
| 12 | Codex | `scripts/baseline4_generate_novel_views.py`, `scripts/baseline4_generate_novel_views.slurm` | Baseline4 top-250 cosine novel-view dataset generation using DA3-GIANT Gaussian splats and confidence-masked reprojected depth |
